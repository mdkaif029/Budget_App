...
var budgetController = (function() {
    ...
    return {
        ...
        deleteItem: function(type, id) {
            ...
            // maps return all the ids stored in an array.
            ...
            // Splice method will delete the element in that index and 1 denotes number of item to be deleted
            if (index !== -1) {
        ...
        getPercentages: function() {
            // storing all the percentages in an array using map function.
